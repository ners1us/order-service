...
help:
	...
	echo "   make rest-logs             - Show REST Аpp logs"
	echo "   make rest-logs-follow      - Follow REST Аpp logs"
	echo "   make grpc-logs             - Show gRPC Аpp logs"
	echo "   make grpc-logs-follow      - Follow gRPC Аpp logs"
